                ...
                <div class="row justify-content-between flex-lg-row-reverse align-items-center">
                    <div class="col-lg-5">
                        <div class="parallax_wrapper">
                            <img src="img/home_2ooak.webp" alt="a nother view villa isla" class="img-fluid rounded-img" loading="lazy">
                            <div data-cue="slideInUp" class="img_over"><span data-jarallax-element="-30"><img src="img/home_1ooak.webp" alt="drone view villa Aqua" class="rounded-img" loading="lazy"></span></div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="intro">
            ...
            <div class="container margin_120_95">
                    ...
                    <div class="col-lg-6">
                        <div class="pinned-image rounded_container pinned-image--small mb-4">
                            <div class="pinned-image__container">
                                <img src="img/resto_1.webp" alt="Azura Bistro Resto have vie garden" loading="lazy">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                ...
                <div class="row justify-content-between d-flex align-items-center add_bottom_90">
                    <div class="col-lg-6 order-lg-2">
                        <div class="pinned-image rounded_container pinned-image--small mb-4">
                            <div class="pinned-image__container">
                                <img src="img/kindstore_2.webp" alt="Store at One Of A Kind, you can find souvenir or gift here" loading="lazy">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-between d-flex align-items-center">
                    <div class="col-lg-6">
                        <div class="pinned-image rounded_container pinned-image--small mb-4">
                            <div class="pinned-image__container">
                                <img src="img/mainpool_4.webp" alt="Infinity Pool have beautyview straigh to the sea" loading="lazy">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
