<header class="reveal_header">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-6">
                    <nav>
                        <ul>
                            <li><a href="https://wa.me/+6282313099999" class="btn_1 btn_scrollto">Reservation</a></li>
                            <li>
    ...
    <div class="nav_panel">
        ...
        <div class="logo_panel"><img src="img/logo_sticky_ooak.png" width="135" height="45" alt="Logo One Of A Kind Resort Bintan"></div>
            ...
            <nav>
                <ul class="level-1">
                    ...
                    <li class="parent"><a href="#0">Promo & Package</a>
                        <ul class="level-2">
                            <li class="back"><a href="#0">Back</a></li>
                            <li><a href="#">Promo of The Month</a></li>
                            <li><a href="#">Meeting Package</a></li>
                            <li><a href="#">Romantic Package</a></li>
                            <li><a href="#">Wedding Package</a></li>
                            <li><a href="#">Sea Activity</a></li>
                            <li><a href="#">Stay & Tour Package</a></li>
                        </ul>
                    </li>
                ...
                <div class="panel_footer">
                    <div class="phone_element"><a href="https://wa.me/+6282313099999" ><i class="bi bi-telephone"></i><span><em>Info and bookings</em>+62 823 1309 9999</span></a></div>
                </div>
                <!-- /panel_footer -->
            </nav>
        </div>
