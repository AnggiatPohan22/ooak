<div class="bg_white">
            <div class="container margin_120_95">
                <div class="title mb-3">
                    <small data-cue="slideInUp">Hot Deals Package</small>
                ...
                <!--/row -->
                <p class="text-end"><a href="#" class="btn_1 outline mt-2" data-cue="slideInUp" data-delay="600">View all Packages</a></p>
            </div>
            <!--/container -->
        </div>