<div class="container margin_120_95">
            <div class="title mb-3">
                ...
                <h2 data-cue="slideInUp" data-delay="200">Our Villa's</h2>
            </div>
            ...
            <div class="title text-center mb-5">
                <small data-cue="slideInUp">One Of A Kind Resort</small>
                <h2 data-cue="slideInUp" data-delay="100">Main Facilities</h2>
            </div>
            <div class="row mt-4">
                <div class="col-xl-3 col-md-6">
                    <div class="box_facilities no-border" data-cue="slideInUp">
                      <!--  <i class="icon-Glyphter-159276"></i> -->
                        <i class="customicon-private-parking"></i>
                        <h3>Free Parking</h3>
                        <p>Free and Save parking because have CCTV & Security 24 Hours to always check situation area Resort</p>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
                    <div class="box_facilities" data-cue="slideInUp">
                        ...
                        <p>available wifi every public and private room.</p>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
                    <div class="box_facilities" data-cue="slideInUp">
                        ...
                        <p>We have 2 Resto which is an Asian or  Western and a Sea Food or Chinese Food  </p>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
                    <div class="box_facilities" data-cue="slideInUp">
                        ...
                        <h3>Swimming Pool</h3>
                        <p>The swimming pool has a view spot directly to the sea and is free for our guests. </p>
                    </div>
                </div>
            </div>
            <!-- /Row -->
