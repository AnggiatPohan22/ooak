            ...
            <div class="wrapper opacity-mask d-flex align-items-center  text-center animate_hero" data-opacity-mask="rgba(0, 0, 0, 0.5)">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <small class="slide-animated one">Luxury Modern at Sea</small>
                            <h1 class="slide-animated two">Villa Aqua President</h1>
                       <!--  <p class="slide-animated three">Luxury Modern at Sea</p> -->   
                        </div>
                    </div>
                </div>
        ...
        <div class="bg_white" id="first_section">
            <div class="container margin_120_95">
                <div class="row justify-content-between">
                    <div class="col-lg-4">
                        <div class="title">
                            <small>Villa Aqua President</small>
                            <h2>Modern at Sea</h2>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="room_facilities_list">
                            <ul data-cues="slideInLeft">
                                ...
                                <li><i class="icon-hotel-double_bed_2"></i> Twin Single Bed</li>
                                <li><i class="icon-hotel-swimming_pool"></i> Private Plunge Pool</li>
                                <li><i class="icon-hotel-swimming_pool"></i> Family Room</li>
                                <li><i class="icon-hotel-double_bed_2"></i> Dining Area</li>
                                <li><i class="icon-hotel-double_bed_2"></i> Rooftop for BBQ</li>
                                ...
                                <li><i class="icon-hotel-double_bed_2"></i> Two Private Bathroom</li>
                                <li><i class="icon-hotel-double_bed_2"></i> Guest Bathroom</li>
